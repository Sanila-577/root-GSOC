...
set(ROOT_CXX_FLAGS " -m64 -pipe -fsigned-char -fsized-deallocation -fno-common -Qunused-arguments -pthread -stdlib=libc++")
...
set(ROOT_INCLUDE_DIRS /Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/include)


# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_LIBRARY_DIR /Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/lib)


# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_BINDIR /Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/bin)


# Deprecated value, please don't use it and use ROOT_BINDIR instead.
set(ROOT_BINARY_DIR /Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/bin)


# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_CMAKE_DIR /Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/cmake)


# Python version used to build ROOT
set(ROOT_PYTHON_VERSION 3.12.12)
...
set(_root_enabled_options  asimage builtin_clang builtin_cling builtin_civetweb builtin_davix builtin_freetype builtin_ftgl builtin_gif builtin_gl2ps builtin_jpeg builtin_llvm builtin_lzma builtin_nlohmannjson builtin_openui5 builtin_pcre builtin_png builtin_tbb builtin_vdt builtin_xrootd builtin_xxhash builtin_zstd check_connection clad cocoa curl dataframe davix gdml geom http imt libcxx opengl pyroot roofit root7 runtime_cxxmodules shared spectrum sqlite ssl thisroot_scripts tmva tmva-cudnn tmva-pymva tmva-sofie tpython use_gsl_cblas vdt webgui xml xrootd)
set(_root_all_options  arrow asimage asimage_tiff asserts builtin_cfitsio builtin_clang builtin_cling builtin_civetweb builtin_cppzmq builtin_davix builtin_fftw3 builtin_freetype builtin_ftgl builtin_gif builtin_gl2ps builtin_gsl builtin_gtest builtin_jpeg builtin_llvm builtin_lz4 builtin_lzma builtin_nlohmannjson builtin_openssl builtin_openui5 builtin_pcre builtin_png builtin_tbb builtin_unuran builtin_vdt builtin_xrootd builtin_xxhash builtin_zeromq builtin_zlib builtin_zstd ccache cefweb check_connection clad cocoa coverage cuda curl daos dataframe davix dcache dev distcc experimental_adaptivecpp experimental_genvectorx fcgi fftw3 fitsio fortran gdml geom geombuilder gnuinstall gviz http imt libcxx llvm13_broken_tests macos_native mathmore memory_termination minuit2_mpi minuit2_omp mpi opengl pyroot pythia8 qt6web r roofit roofit_multiprocess root7 runtime_cxxmodules shadowpw shared soversion spectrum sqlite ssl test_distrdf_dask test_distrdf_pyspark testsupport thisroot_scripts tmva tmva-cpu tmva-cudnn tmva-gpu tmva-pymva tmva-rmva tmva-sofie tpython unfold unuran uring use_gsl_cblas vdt vecgeom webgui win_broken_tests winrtdebug x11 xml xrootd)
