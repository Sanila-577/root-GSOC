...
set_target_properties(clingInterpreter PROPERTIES
  INTERFACE_LINK_LIBRARIES "clingUtils;clangCodeGen;clangDriver;clangFrontend;clangInterpreter;clangParse;clangSema;clangAnalysis;clangEdit;clangRewrite;clangRewriteFrontend;clangSerialization;clangAST;clangBasic;clangLex;LLVMAnalysis;LLVMCore;LLVMCoroutines;LLVMCoverage;LLVMExecutionEngine;LLVMipo;LLVMJITLink;LLVMLTO;LLVMMC;LLVMObject;LLVMOption;LLVMOrcJIT;LLVMOrcDebugging;LLVMRuntimeDyld;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTransformUtils;LLVMBinaryFormat;LLVMAArch64CodeGen;LLVMAArch64AsmParser;LLVMAArch64Desc;LLVMAArch64Disassembler;LLVMAArch64Info;LLVMAArch64Utils"
)
...
set_target_properties(clingInterpreter PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/lib/libclingInterpreter.a"
  )
...
set_target_properties(clingMetaProcessor PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/lib/libclingMetaProcessor.a"
  )
...
set_target_properties(clingUtils PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/lib/libclingUtils.a"
  )
...
set_target_properties(clingDemoPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/interpreter/cling/tools/plugins/example/libclingDemoPlugin.dylib"
...
foreach(_target "clangCodeGen" "clangDriver" "clangFrontend" "clangInterpreter" "clangParse" "clangSema" "clangAnalysis" "clangEdit" "clangRewrite" "clangRewriteFrontend" "clangSerialization" "clangAST" "clangBasic" "clangLex" "LLVMAnalysis" "LLVMCore" "LLVMCoroutines" "LLVMCoverage" "LLVMExecutionEngine" "LLVMipo" "LLVMJITLink" "LLVMLTO" "LLVMMC" "LLVMObject" "LLVMOption" "LLVMOrcJIT" "LLVMOrcDebugging" "LLVMRuntimeDyld" "LLVMScalarOpts" "LLVMSupport" "LLVMTarget" "LLVMTransformUtils" "LLVMBinaryFormat" "LLVMAArch64CodeGen" "LLVMAArch64AsmParser" "LLVMAArch64Desc" "LLVMAArch64Disassembler" "LLVMAArch64Info" "LLVMAArch64Utils" )
