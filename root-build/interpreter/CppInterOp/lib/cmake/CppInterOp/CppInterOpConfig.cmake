...
if (IS_DIRECTORY "${CPPINTEROP_INSTALL_PREFIX}/include")
  ...
  set(_include "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/interpreter/CppInterOp/include")
  set(_lib "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/interpreter/CppInterOp/${shared_lib_dir}/${_lib_prefix}clangCppInterOp${_lib_suffix}")
  set(_cmake "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/interpreter/CppInterOp/${shared_lib_dir}/cmake/CppInterOp")
endif()
...
set(CPPINTEROP_VERSION "1.9.0\;dev")
...
if (MSVC)
  if (IS_DIRECTORY "${CPPINTEROP_INSTALL_PREFIX}/include")
    ...
    set(_static_lib "/Users/sanilawijesekara/Documents/gsoc/Root/root-GSOC/root-build/interpreter/CppInterOp/lib/${_lib_prefix}clangCppInterOp.lib")
  endif()
